										...
										<div>
											...
											>
												{deptCountLoading ? (
													...
													deptCount.totalCount
												)}
											</h3>
										</div>
										<div>
											<p className="text-white mb-0 small">Total Complaints</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div className="card">
									...
									>
										<div>
											...
											<p className="text-white mb-0 small">Open Complaints</p>
										</div>
									</div>
								</div>
							</div>
										...
										<div>
											...
											>
												{deptCountLoading ? (
													...
													deptCount.closedCount
												)}
											</h3>
											<p className="text-white mb-0 small">Closed Complaints</p>
										</div>
									</div>
								</div>
							) : (
